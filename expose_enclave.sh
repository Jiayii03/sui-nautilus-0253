...
sleep 5
# Secrets-block
SECRET_VALUE=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:ap-southeast-1:886436967137:secret:weather-api-suibian-D6kkTz --region ap-southeast-1 | jq -r .SecretString)
